...
import cn.wanxue.common.LogUtil;
        ...
        try {
            ...
            switch (Media) {
                    ...
                    if (TextUtils.isEmpty(path)) {
                        ...
                        Toast.makeText(MediaPlayerDemo_Video.this,
                                "Please edit MediaPlayerDemo_Video Activity, " +
                                        ...
                                        " Your media file must be stored on sdcard.", Toast
                                                                                              .LENGTH_LONG)
                                .show();
                        return;
                    }
                ...
                case STREAM_VIDEO:
                     ...
                     *
                     */
                    path = "http://www.quirksmode.org/html5/videos/big_buck_bunny.mp4";
                    if (TextUtils.isEmpty(path)) {
                        // Tell the user to provide a media file URL.
                        Toast.makeText(MediaPlayerDemo_Video.this,
                                "Please edit MediaPlayerDemo_Video Activity," +
